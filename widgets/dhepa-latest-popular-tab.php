...
class Dhepa_Latest_Popular_Tab extends WP_Widget
{
    ...
    {
        $widget_ops = array(
            'classname' => 'dhepa_latest_popular_tab',
            'description' => 'This widget will show Latest & Popular Post Tab',
        );
        parent::__construct('dhepa_latest_popular_tab', 'Dhepa Latest & Popular Post Tab', $widget_ops);
    }
    public function form($instance)
    {
        echo "<p>This widget will show Latest & Popular Post Tab</p>";
    }
    /**
...
add_action('widgets_init', function () {
    register_widget('Dhepa_Latest_Popular_Tab');
});
